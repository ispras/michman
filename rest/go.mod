...
replace github.com/ispras/michman/auth => ../auth

replace github.com/ispras/michman/rest/authorization => ./authorization
...
require (
	...
	github.com/ispras/michman/auth v0.0.0-00010101000000-000000000000
	...
	github.com/ispras/michman/rest/authorization v0.0.0-00010101000000-000000000000
