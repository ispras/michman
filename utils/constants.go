...
const (
	...
	AnsibleMainRole = "launcher/ansible/main.yml"
	//ansible get master ip role path
	AnsibleMasterIpRole = "launcher/ansible/get_master.yml"
	//ansible get ip of any instance with role
	AnsibleIpRole = "launcher/ansible/get_ip.yml"
...
var (
	SshKeyPath  = os.Getenv("PWD") + "/launcher/ansible/files/ssh_key"
