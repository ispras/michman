...
Внутренняя модель представлений данных Michman подразумевает логическое разделение кластеров на группы внутри проектов системы. Пользователи могут получить доступ к информации о кластеров только из тех проектов, членами которых они являются. На основе такого разделения в Michman реализованы три роли:
